      ...
      tabItem(tabName = "explore",
              tabsetPanel(
                ...
                tabPanel(
                  "Improvements",
                  br(),
                  textOutput("exploreOptionsSummaryTitle"),
                  br(),
                  dataTableOutput("exploreOptionsSummary")
                ),
                tabPanel(
                  "Times",
                  br(),
                  ...
                  br(),
                  box(
                    plotlyOutput("exploreOutputParallelMethod")
                  ),
                  box(
                    plotlyOutput("exploreOutputParallel")
                  ),
                  box(
                    plotlyOutput("exploreOutputBranchBound")
                  ),
                  box(
                    plotlyOutput("exploreOutputSorted")
                  ),
                  box(
